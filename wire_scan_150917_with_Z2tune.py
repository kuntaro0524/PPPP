...
def wire_rough_scan(sx,sy,sz): #sx,sy,sz = wire default
	## Wire rough scan
	## wire defalut positions were 200um apart from wire edge
	## change by Y.K. 150116
	#ssz = sz + 0.1
	ssz = sz + 0.15
...
## 	Gonio defalut positions were 200um apart from wire edge
	sx= 0.8962
	sy=-2.4062
	sz= 0.0845
...
## 	Energy list
	enlist=[10.5,12.3984,15.5,18.5]
##	enlist=[8.5,12.3984,18.5]
	#enlist=[12.3984,15.5,18.5,8.5,10.5]
	#enlist=[12.3984]

## 	TCS aperture list
	# Itsumono
	# Normally used
	#tcs_list=[(0.026,0.040),(0.05,0.05),(0.07,0.07),(0.1,0.1),(0.2,0.2),(0.5,0.5),(1.0,1.0),(2.0,2.0),(0.5,0.04),(1.0,0.04)]
	tcs_list=[(0.026,0.040),(0.1,0.1),(0.2,0.2),(0.3,0.3),(0.5,0.5),(1.0,1.0),(0.5,0.04),(1.0,0.04)]
...
## 	DANGEROUS!!! deleted 2014/06/24 by K.Hirata
	#gonio.prepScan()
