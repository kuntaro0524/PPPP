...
if __name__=="__main__":
	...
	while(1):
		...
		osc=float(raw_input())
		print "Desired exposure time [sec]:"
		exptime=float(raw_input())
	...
	if trans_Desi > 1.0:
		exp_Desi=trans_KUMA*osc/rate_KUMA
		print "Use non-attenuated beam with %5.2f sec exposure time"%exp_Desi
	else:
		att_Desi=att.calcThickness(wave,trans_Desi)
		print "Attenuator= %10.3f[um]"%att_Desi
