...
class MultiCrystal:
	...
	def make(self,sch_file,info_list,beam_index=0):
	...
	def makeGUI(self,outdir,wavelength,info_list,distance,startphi,endphi,osc_width,att_thick,bs_index=0):
		...
		self.make(ofile,info_list,beam_index=bs_index)
