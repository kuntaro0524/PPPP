...
cnt_ch1=3 # PIN photodiode
cnt_ch2=0 # IC

while True:

# Filename
    #en_list=[8.5,10.0,11.0,12.0,12.398,14.0,16.0,18.0,20.0]
    en_list=[10.0,11.0,12.0,12.398,14.0,15.0,16.0,17.0,18.0,19.0,20.0]
