...
# Devices
	...
	# 20100705 - Fixed point scan for 1 hour x 8 times for each energy (See test.conf)
	# 20100713 - Fixed point scan for 1 hour x 6 times for each energy (See test.conf)
	str=fixedp.doSimpleMonitor(prefix)
