...
Data Directory: /isilon/users/target/target/Staff/150619/ProgCheck/
Sample Name: test
Serial Offset:    16
...
Scan Condition:    48.20    49.80     0.20  # from to step [deg]
...
CCD Adc: 1  # 0:Normal  1:High gain 2:Low noise 3:Do not use (select Normal)
...
Advanced vector centering type: 0 # 0: set step, 1: auto step, 2: gradual move
Advanced npoint: 8 # [mm]
Advanced step:   0.0500 # [mm]
Advanced interval: 1 # [frames]
Advanced gonio coordinates 1:      0.60839      0.54387      0.63817 # id, x, y, z
Advanced gonio coordinates 2:      0.61806      0.89407      0.63052 # id, x, y, z
