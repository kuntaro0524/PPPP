...
class PointCry:
	...
	def qqq(self,image1,image2):
		i1=pygame.image.load(image1).convert()
		i2=pygame.image.load(image2).convert()

		while True:
			self.screen.blit(i1,(0,0))
			self.screen.blit(i2,(0,480))
    			pygame.display.update()

	def setBackImages(self,image1,image2):
		i1=pygame.image.load(image1).convert()
		i2=pygame.image.load(image2).convert()
		self.screen.blit(i1,(0,0))
		self.screen.blit(i2,(0,480))

	def pickPoints(self,image1,image2):
		while True:
			self.setBackImages(image1,image2)
...
if __name__ == "__main__":
	...
	ttt=PointCry("image000.ppm")

	ttt.pickPoints("test1.ppm","test2.ppm")
