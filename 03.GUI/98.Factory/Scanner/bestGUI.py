...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_7_staticbox = wx.StaticBox(self.notebook_1_pane_1, -1, "")
        ...
        self.button_1_copy_copy = wx.Button(self.notebook_1_pane_1, -1, "Index and Integrate")
        self.button_1 = wx.Button(self.notebook_1_pane_1, -1, "Show strategy")
        self.label_5 = wx.StaticText(self.notebook_1_pane_1, -1, "Desired")
        self.label_6_copy = wx.StaticText(self.notebook_1_pane_1, -1, "Resolution")
        self.text_ctrl_1 = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.label_6 = wx.StaticText(self.notebook_1_pane_1, -1, "[A]")
        self.label_6_copy_copy = wx.StaticText(self.notebook_1_pane_1, -1, "Redundancy")
        self.text_ctrl_1_copy = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.checkbox_1 = wx.CheckBox(self.notebook_1_pane_1, -1, "Anomalous")
        ...
        self.Bind(wx.EVT_BUTTON, self.pushIntegrate, self.button_1_copy_copy)
        self.Bind(wx.EVT_BUTTON, self.yarude, self.button_1)
        self.Bind(wx.EVT_CHECKBOX, self.anoCheck, self.checkbox_1)
        # end wxGlade
    ...
    def __set_properties(self):
        ...
        self.SetTitle("bestGUI")
        self.label_4.SetMinSize((100, 18))
        self.label_4.SetFont(wx.Font(10, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        self.filenameBox.SetMinSize((450, 24))
        self.label_5.SetMinSize((90, 22))
        self.label_5.SetFont(wx.Font(12, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        self.text_ctrl_1.SetMinSize((50, 28))
        self.text_ctrl_1_copy.SetMinSize((50, 28))
    ...
    def __do_layout(self):
        ...
        sizer_6.Add(self.button_1_copy, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_2.Add(sizer_6, 1, wx.EXPAND, 0)
        sizer_4.Add((200, 20), 0, wx.ADJUST_MINSIZE, 0)
        sizer_4.Add(self.button_1_copy_copy, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_4.Add(self.button_1, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_2.Add(sizer_4, 1, wx.EXPAND, 0)
        sizer_7_copy.Add((20, 20), 0, wx.ADJUST_MINSIZE, 0)
        sizer_7_copy.Add(self.label_5, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
        sizer_7_copy.Add(self.label_6_copy, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7_copy.Add(self.text_ctrl_1, 0, wx.ADJUST_MINSIZE, 0)
        sizer_7_copy.Add(self.label_6, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7_copy.Add((20, 20), 0, wx.ADJUST_MINSIZE, 0)
        sizer_7_copy.Add(self.label_6_copy_copy, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7_copy.Add(self.text_ctrl_1_copy, 0, wx.ADJUST_MINSIZE, 0)
        sizer_7_copy.Add(self.checkbox_1, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def pushIntegrate(self, event): # wxGlade: MyFrame.<event_handler>
        print "Event handler `pushIntegrate' not implemented"
        event.Skip()

    def anoCheck(self, event): # wxGlade: MyFrame.<event_handler>
        print "Event handler `anoCheck' not implemented"
        event.Skip()
