#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Fri May 28 02:44:30 2010
...
class MyFrame(wx.Frame):
	...
	time.sleep(1.0)
        ...
        res_time=(currtime-self.starttime).seconds
	difstr="%8.5f"%res_time
	self.remainedTime.SetValue(difstr)

        #self.whileLoop(event)

    def whileLoop(self,event):
        while(1):
           time.sleep(1.0)
           currtime=datetime.datetime.now()
