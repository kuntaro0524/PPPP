...
class MyFrame2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.datadireBox = wx.TextCtrl(self, -1, "/data/20150219/COCcO/")
        ...
        self.label_2 = wx.StaticText(self, -1, "Inclination from shoumen")
        self.startPhiBox = wx.TextCtrl(self, -1, "0.0")
        self.label_2_copy_1 = wx.StaticText(self, -1, "SHOUMEN_ANGLE[deg.]")
        self.shoumenBox = wx.TextCtrl(self, -1, "0.0")
        ...
        self.vecAXbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.1374")
        self.vecAYbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "1.0968")
        self.vecAZbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.6132")
        ...
        self.vecBXbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.3279")
        self.vecBYbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.7279")
        self.vecBZbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.5812")
        ...
        self.vecCXbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "-0.0345")
        self.vecCYbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.5709")
        self.vecCZbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.3950")
        ...
        self.vecDXbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "-0.2067")
        self.vecDYbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.9259")
        self.vecDZbox = wx.TextCtrl(self.notebook_1_pane_1, -1, "0.4134")
    ...
    def __do_layout(self):
        ...
        sizer_19.Add(self.startPhiBox, 0, wx.ADJUST_MINSIZE, 0)
        sizer_19.Add((150, 20), 0, wx.ADJUST_MINSIZE, 0)
    ...
    def estimation(self,makeFlag=False):
	outdir=self.datadireBox.GetValue()
        ms=MakeSchedule("/data3/20150219/COCcO/ScheduleFiles/oxi.sch",outdir)
	...
	# Shoumen PHI & Start PHI
	startphi=float(self.startPhiBox.GetValue())
        self.shoumen_phi=float(self.shoumenBox.GetValue())
	print "SHOUMENPHI::::",self.shoumen_phi
	print "STARTPHI::::::",startphi
        n_points=ms.generateSchedule(self.shoumen_phi,startphi)
	print n_points
	self.nFramesBox.SetValue("%d"%n_points)
