...
outdir="/isilon/users/target/target/Staff/2014B/150209/00.CcOTest/"
...
for svec_evec in svec_evecs:
	...
	# Startphi = -60.0 deg
	################################
	inclination_from_m60deg=phi_rel+60.0
	serial_offset=int(inclination_from_m60deg/stepphi)
	print "INCLINATION from -60.0 deg",inclination_from_m60deg,serial_offset
