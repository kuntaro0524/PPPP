...
if __name__=="__main__":
	...
	# Beam position log
	bplogname="/staff/bl32xu/BLsoft/Logs/beam.log"
	...
	if DTTUNE==True:
		# dttune
		print "HERE"
		mng.changeE(20.0) # 20 keV
		#mng.changeE(17.712) # 0.7 Ang
		#mng.changeE(13.7760) # 0.94 Ang
		#mng.changeE(12.3984) # 1.0 Ang
		#mng.changeE(9.9988) # 0.24 Ang
		dttune_fwhm,dttune_center=mng.dttunePeak()  
		#dttune_fwhm,dttune_center=mng.dttunePeakE()  # for LowEnergy ( E < 10.0 kev)
