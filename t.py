...
class Centering:
	def __init__(self,ms,sample_name="sample"):
		...
		self.backimg="/isilon/BL32XU/BLsoft/PPPP/10.Zoo/BackImages/20161008/back.ppm"
	...
	def coreCentering(self,phi_list,loop_size="small"):
		...
		phi_area_list=[]
		n_good=0
		print "DEBUG LOOP in coreCentering"
		for phi in phi_list:
			self.coi.rotatePhi(phi)
...
if __name__ == "__main__":
	...
	backimg="/isilon/BL32XU/BLsoft/PPPP/10.Zoo/back_170425.ppm"

	cnt.setBack(backimg)
	rwidth,rheight,phi_face,gonio_info=cnt.doAll(ntimes=2,skip=False,loop_size="large")
