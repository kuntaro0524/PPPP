...
class BM:
	def __init__(self,server):
		...
		self.z_off_pos=-80000 # pulse

		self.x_on_pos=0 # pulse
		self.x_off_pos=8500 # pulse

		# Z limit
		self.z_upper_limit=20000
		self.z_lower_limit=-80770

	def travelLimit2Limit(self):
		self.moni_z.move(self.z_upper_limit)
		z_pulse=int(self.moni_z.getPosition()[0])
		print z_pulse
		self.moni_z.move(self.z_lower_limit)
		z_pulse=int(self.moni_z.getPosition()[0])
		print z_pulse
