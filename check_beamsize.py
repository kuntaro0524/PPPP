...
## 	Wire scan
	for en in enlist:
		...
		for tcs_param in tcs_list:
			...
			logf.write("%8.4f %5.1f %5.1f %5.3f %5.3f %8.3f %8.3f %8.3f %8.3f %s ( IC: %5.2e nA, Pin: %5.2e uA, Flux: %5.2e, Trans: %5.2f percent )\n"%(en,colli_y,colli_z,tcsv,tcsh,zwidth,zcenter,ywidth,ycenter,cntstr,pin_uA,iic_nA,flux,trans))
			logf.flush()
