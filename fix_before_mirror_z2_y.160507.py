	...
	for ty1 in ty1_list:
		...
		for z2 in z2_list:
			...
			# TCS vertical & horizontal scan x 1times
    			...
    			tmp,vcenter1=tcs.scanVrel(prefix,0.05,0.5,3.0,scan_step,cnt_ch2,cnt_ch1,scan_time)
    			tmp,hcenter1=tcs.scanHrel(prefix,0.50,0.05,3.0,scan_step,cnt_ch2,cnt_ch1,scan_time)
			...
			# LOG STRINGS
			logstr="%8.3f,%8.3f,%8d,%8d,%8d,%7.4f,%7.4f,%9.1f,%9.1f,%10d,%10d"%(id.getE(en),en,dt1_center,ty1,z2,vcenter1,hcenter1,slit1_vcenter,slit1_hcenter,ch1,ch2)
			logf.write("%s\n"%logstr)
			logf.flush()
