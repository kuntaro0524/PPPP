...
class TCS:
	...
	def getTest(self):
		...
		upper_pos=self.tcs_upper.getPosition()[0]
		lower_pos=self.tcs_lower.getPosition()[0]

		print ring_pos,hall_pos,upper_pos,lower_pos
	...
	def setTest(self):
		...
		self.tcs_ring.move(-16000)
		#HALL BLADE
		self.tcs_hall.move(-16000)
		self.tcs_hall.move(16000)
		#UPPER BLADE
		self.tcs_upper.move(-16000)
		self.tcs_upper.move(16000)
		#LOWER BLADE
		self.tcs_lower.move(16000)
		self.tcs_lower.move(-16000)
