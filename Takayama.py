...
if __name__=="__main__":
	...
	print "Usage: python ~/PPPP/Takayama.py LENGTH_HORIZONTAL[um] LENGTH_VERTICAL[um] EXPTIME[sec] OUTPUT_DIRECTORY"
...
# LOOP
	...
	time.sleep(5)
	command="cat /tmp/ttt_lars???.sch > ~/all_takayama.sch"
	os.system(command)
