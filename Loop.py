...
class Loop:
	...
	def loopLevel(self):
		self.gonio.rotatePhi(0)
		datafile="/isilon/BL32XU/BLsoft/PPPP/01.Data/00.CenteringPictures/01.LoopOrientation/TEST/180deg.dat"
		ofile=open(datafile,"w")
		maxsum=0.0
		save=0.0
		for i in range(1,18):
			self.gonio.rotatePhiRelative(20)
			filename="/isilon/BL32XU/BLsoft/PPPP/01.Data/00.CenteringPictures/01.LoopOrientation/TEST/%03d_cap.ppm"%i
