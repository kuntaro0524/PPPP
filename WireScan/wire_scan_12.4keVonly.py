...
## 	TCS aperture list
	# Itsumono
	#tcs_list=[(0.026,0.04,0.1),(0.1,0.1,0.2),(0.2,0.2,0.5),(0.3,0.3,0.5),(0.4,0.4,0.5),(0.5,0.5,1.0),(1.0,1.0,1.0)]
	tcs_list=[(0.026,0.04,0.1)]

	# 110424
	#tcs_list=[(0.026,0.04,0.2),(0.130,0.20,0.2),(0.26,0.40,0.5)]
...
## 	Wire scan
	...
	for tcs_param in tcs_list:
		...
		logf.write("%5.2f,%5.2f,%8.3f,%8.3f,%8.3f,%8.3f,%s\n"%(tcsv,tcsh,zwidth,zcenter,ywidth,ycenter,cntstr))
		logf.flush()
