...
## 	TCS aperture list
	...
	# Zakkuri
	tcs_list=[(0.026,0.040,0.1,1.0),(0.122,0.216,0.1,1.0),(0.245,0.5,1.0,1.0)] # square 1um x 1.5um, 5um x 5um, 10um x 10um # 1st
	#tcs_list=[(0.026,0.040,0.1,1.0),(0.122,0.216,0.1,1.0)]
	#tcs_list=[(0.245,0.5,1.0,0.2)] # square 1um x 1.5um, 5um x 5um, 10um x 10um # 1st
