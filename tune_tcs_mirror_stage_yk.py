...
if __name__=="__main__":
	...
	ofile.write("Initial TCS position (TCS_V,TCS_H)=(%7d,%7d)\n"%(tcsv_before,tcsh_before))
	ofile.write("TCS scan after (TCS_V, TCS_H) = %8.5f %8.5f \n(diffv,diffh)=(%8.5f,%8.5f)\n"% \
	...
	# dY, dZ
	diffyum=(center_ymm-curr_sty)*1000.0
	diffzum=(center_zmm-curr_stz)*1000.0
