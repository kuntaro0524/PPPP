...
if __name__=="__main__":
	...
	stmono=Organizer(s,"bl_32in","tc1_stmono_1","dtheta1")
	scan_start=-87000
	scan_end=-89000
	scan_step=-20
	cnt_ch1=1
	...
	cnt_time=0.3
        ...
        maxval=stmono.axisScan(ofile,scan_start,scan_end,scan_step,cnt_ch1,cnt_ch2,cnt_time,unit)

	#print "Time: %8.3f sec"%(time2-time1).seconds

        #print stmono.move(-89000,"pulse")
