...
############################
	...
	## comment out by yam (14-06-17 10:05)
	#def dttunePeak(self):
	#	prefix="%03d"%(self.f.getNewIdx3())
	#	# Delta theta1 tune
	#	fwhm,center=self.mono.scanDt1PeakConfig(prefix,"DTSCAN_NORMAL",self.tcs)
...
if __name__=="__main__":
	...
	#mng.setAtt(1000)
	#def findGoodMetric(self):
	#mng.findGoodMetric()
	#mng.movePintZoomMax()
	#print mng.getIntensityPosition()
	...
	#def doCapAna(self,prefix,avetime=10,nrepeat=1,thicktune=False):
	#mng.tuneAttThick()
