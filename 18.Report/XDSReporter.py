...
class XDSReporter():
    def __init__(self, root_path):
        ...
        self.corrlp_list,self.path_list=self.dp.findTarget("CORRECT.LP")
    ...
    def makeHTML(self,logfile="correct.html",figdpi=60,skipMulti=True):
        # Log file
        log_path = "%s/%s" % (self.rootdir, logfile)
