...
# Devices
	...
	for ty1 in ty1_list:
		...
		slit1_hfwhm,slit1_hcenter=exs.scanH(prefix,-slit1_start,-slit1_end,-slit1_step,slit1_ch0,slit1_ch1,0.2)

		# Log string
		#("Gap[mm],Energy[kev],Dtheta1[pulse],Ty1[pulse],TCS_v,TCS_h,Eslit1_h")
		logstr="%8.3f,%8.3f,%8d,%8d,%7.4f,%7.4f,%9.1f,%9.1f"%(id.getE(en),en,dt1_center,ty1,vcenter1,hcenter1,slit1_vcenter,slit1_hcenter)
		logf.write("%s\n"%logstr)
		logf.flush()
