...
class Device(Singleton.Singleton):
    ...
    def init(self):
        ...
        self.f = File.File("./")
        self.capture = Capture_201001.Capture()
    ...
    def setHyperFocus(self, output_path):
        ...
        # For hyper focusing
        rel_angle_mv_ty = +2500 # pls
        rel_angle_mh_tz = +400 # pls

        # Aimed position of mv_ty, mh_tz
        target_mv_ty = curr_mv_ty + rel_angle_mv_ty
        target_mh_tz = curr_mh_tz + rel_angle_mh_tz
