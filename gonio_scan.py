...
class Gonio:
	...
	def __init__(self,server):
		...
		#self.convertion=6667 # YK 230406
		#self.base=210.0 # YK 230406
	...
	def rotatePhi(self,phi):
		#convertion=6667 #deg2pulse # YK 230406
		convertion=5000 #deg2pulse
		dif=phi*convertion
	...
	def scanEncY(self,prefix,start,end,step,cnt_ch1,cnt_ch2,time):
		ofile=prefix+"_scanY.scn"
		self.scanEnc(self.gonioy,prefix,start,end,step,cnt_ch1,cnt_ch2,time)
