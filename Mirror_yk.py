...
### Translational axes
	...
	def tuneVFM_z(self,center_pulse):
		...
		scan_start_p=center_pulse - 15000
		scan_end_p=center_pulse + 15000
		scan_step_p=1000
		...
		self.vfm_z.axisScan(ofile,cnt_ch,cnt_ch2,cnt_time)
		print "end scan"
	...
	def tuneHFM_y(self,center_pulse):
		...
		self.hfm_y.axisScan(ofile,cnt_ch,cnt_ch2,cnt_time)
		print "end scan"
