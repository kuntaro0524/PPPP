#!/bin/env python 
z2corr = False  # 150918 Monochromator Z2 flag #Read 'calcZ2' part # 160507 True -> False by K.Hirata
import sys
import socket
import time
...
class Mono:
    ...
    def calcZ2_till_160406(self, energy):
    ...
    def calcZ2_till_160507(self, energy):
        # 160406 K.Hirata wrote
        # I collected vertical beam position at the front of
        # focusing mirror.
        # Ty1/Z2/slit1 V position
        # Data were in Staff/2016A/160404-160405 folder

        # Energy range with larger offset value
        if energy < 10.5:
            z2float = 245.0 * energy + 2125.0
            z2int = int(z2float)
        else:
            z2float = 94.06 * energy + 332.0
            z2int = int(z2float)
        print "estimated Z2 is ", z2int
        return z2int

    def calcZ2(self, energy):
        # 160508 K.Hirata wrote
        # I collected vertical beam position at the front of
        # focusing mirror.
        # Ty1/Z2/slit1 V position
        # Data were in Staff/2016A/160507 folder

        # Energy range with larger offset value
        if energy < 10.5:
            z2float = 429.0 * energy - 95.5
            z2int = int(z2float)
        else:
            z2float = 61.77 * energy + 784.0
            z2int = int(z2float)
        print "estimated Z2 is ", z2int
        return z2int
    ...
    def getTy1(self):
        return (int(self.m_thetay1.getPosition()[0]))
